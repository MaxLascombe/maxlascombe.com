...
> = {
  ...
  2025: {
    ...
    goals: [
      ...
      ['Read 25 books', 0, 25],
      ['Meditate 200 times', 2, 200],
      ['Watch 100 movies', 0, 100],
      ['Spend 0 minutes on Twitter or TikTok', 1, 1],
      ['Learn how to lift weights', 0, 1],
      ['Train for and complete a 5k, ...', 0, 1],
      ['... a 10k, ...', 0, 1],
      ['... and a half marathon', 0, 1],
      ['Check 6 items off my bucket list', 0, 6],
      ['Travel to 3 new countries', 0, 3],
      ['Donate blood', 0, 1],
      ['Complete my work milestones', 0, 13],
    ],
  },
}
