...
> = {
  ...
  2024: {
    ...
    goals: [
      ['Publish 42 creations (including newsletters)', 22, 42],
      ['Read 25 books', 20, 25],
      ['Meditate 250 times', 230, 250],
      ['Do 36,500 pushups', 16_789, 36_500],
      ['Do 100 endurance workouts', 60, 100],
      [
      ...
      ['Complete all work milestones', 14, 14],
    ],
  },
}
