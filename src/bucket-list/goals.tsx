...
export const goals: (Header | [Title, Date | null])[] = [
  'Travel',
  ['Live for a year in a new country (not France or the US)', null],
  ...
  ['Travel through Asia for six months', null],
  'Physical feats',
  ['Go skydiving', null],
  ...
  ['Surf a 3-foot wave', null],
  ['Do ten pull-ups in a row', null],
  ['Compete in a boxing match', null],
  ['Run a 5k in under 25 minutes', null],
  ['Run a sub-4-hour marathon', null],
  ['Run a 10k in under 50 minutes', null],
  ...
  ['Eat at a 3 Michelin star restaurant', null],
